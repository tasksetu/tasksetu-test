...
const EmptyState = () => (
  <div className="bg-white border border-gray-200 rounded-sm shadow-sm p-0 h-full min-h-[400px] flex flex-col justify-center items-center">
      ...
      {!showCalendarView &&
        (apiLoading ? (
          ...
          <div className="flex-1 overflow-y-auto min-h-0 mt-4">
            <EmptyState onTaskCreate={onCreateTask} />
          </div>
        ) : (
